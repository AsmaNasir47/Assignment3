...
public class Financial extends JFrame {
	...
	public Financial() {
		...
		JLabel lblNewLabel_1_2 = new JLabel("(EMPLOYEES SALARY)");
		lblNewLabel_1_2.setBounds(22, 22, 314, 35);
		panel_2.add(lblNewLabel_1_2);
		lblNewLabel_1_2.setFont(new Font("Bell MT", Font.BOLD, 20));
		
		JLabel lblNewLabel_1 = new JLabel("TOTAL INCOME");
		lblNewLabel_1.setBounds(45, 0, 211, 35);
		panel_2.add(lblNewLabel_1);
		lblNewLabel_1.setFont(new Font("Bell MT", Font.BOLD, 20));
		...
		JLabel lblNewLabel_1_1 = new JLabel("TOTAL EMPLOYEES SALARY");
		lblNewLabel_1_1.setBounds(10, 11, 333, 45);
		panel_3.add(lblNewLabel_1_1);
		lblNewLabel_1_1.setFont(new Font("Bell MT", Font.BOLD, 20));
		...
		lblNewLabel_1_2_1.setFont(new Font("Bell MT", Font.BOLD, 19));
		...
		lblNewLabel_1_3.setFont(new Font("Bell MT", Font.BOLD, 19));
		lblNewLabel_1_3.setBounds(10, 0, 334, 35);
		...
		GrossButton.setFont(new Font("Arial", Font.BOLD, 20));
		...
		NetButton.setFont(new Font("Arial", Font.BOLD, 20));
		...
		ResetButton.setFont(new Font("Ebrima", Font.BOLD, 30));
		...
		ExitButton.setFont(new Font("Ebrima", Font.BOLD, 30));
